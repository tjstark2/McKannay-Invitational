...
export function AddScoreScreen() {
  ...
  const calculatedNet = canCalculate
    ? netScore(selectedPlayer, selectedRound, parsedScore, courses, scoringSettings)
    : null;

  const calculatedPlusMinus = canCalculate
    ? playerNetToPar(selectedPlayer, selectedRound, parsedScore, courses, scoringSettings)
    : null;
  ...
  return (
    <div className="space-y-4">
      <SectionHeader
        title="Add Score"
        subtitle="Saved locally and reflected across the whole app."
      />
